...
public class JugadorResource {
    ...
    @RequestMapping(value = "/bp-by-canastas/{canastasTotales}",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<List<Jugador>> get(@PathVariable Integer canastasTotales) {
        log.debug("REST request to get Jugador : {}", canastasTotales);
        List<Jugador> jugadores= jugadorRepository.EcuentraCanastas(canastasTotales);

        return new ResponseEntity<>(jugadores, HttpStatus.OK);

    }
    //doble param
    @RequestMapping(value = "/equipos/{equiposelec}/bp-by-cananastas/{canastasTotales}",


        method = RequestMethod.GET,
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<List<Jugador>> getdobleparam(@PathVariable Integer canastasTotales, @PathVariable Long equiposelec) {

        List<Jugador> jugadores= jugadorRepository.Variante(canastasTotales, equiposelec);
